...
def test_lesson_mode_keeps_conversation_emotions_behind_lesson_scene():
    ...
    guard_branch = body[guard_index:thinking_index]
    assert "lv_obj_add_flag(emoji_box_, LV_OBJ_FLAG_HIDDEN)" in guard_branch
    assert "lv_obj_add_flag(emoji_image_, LV_OBJ_FLAG_HIDDEN)" in guard_branch
    assert "lv_obj_add_flag(emoji_label_, LV_OBJ_FLAG_HIDDEN)" in guard_branch
