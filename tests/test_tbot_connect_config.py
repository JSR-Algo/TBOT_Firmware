...
CURRENT_OTA_BUILD_VERSION = "2.2.91"
...
def maintained_build_configs() -> list[Path]:
    # The resolved sdkconfig is ignored and generated by ESP-IDF build preflights.
...
def test_websocket_protocol_adds_identity_query_params_without_auth_query_or_logging_token():
    ...
    assert "replacement_websocket->Connect(connect_url.c_str())" in websocket_cc
    assert "websocket_->Connect(connect_url.c_str())" not in websocket_cc
