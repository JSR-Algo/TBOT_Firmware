...
def test_combined_cmake_registers_both_identity_candidates_in_correct_profiles():
    ...
    assert 'set(TBOT_HIL_PROFILE "production" CACHE STRING' in root_cmake
    ...
    assert 'PRIVATE TBOT_HIL_PROFILE=\\"${TBOT_HIL_PROFILE}\\"' in main_cmake
...
def test_websocket_emits_build_identity_on_replacement_before_connect():
