...
This document provides instructions on how to configure and build the firmware for **Movecall Moji2.0 (Tbot AI Edition)**.
...
> **Tbot Assistant** -> **Board Type** -> **Movecall Moji2.0 TbotAI衍生版**
