...
- [ ] Document or remove callback-bearing generation lifecycle APIs so every lifecycle-owned callback has an explicit bounded no-network/no-reentry contract.
