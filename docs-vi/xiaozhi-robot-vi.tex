...
\pagestyle{fancy}
\fancyhf{}
\rhead{\small\textit{Xiaozhi Robot — Tài liệu tích hợp}}
...
\title{
  \vspace*{1cm}
  \textbf{\Huge Xiaozhi AI Robot}\\[6pt]
...
\textbf{Wake word} hiện tại: \texttt{wn9s\_hiesp} (nhỏ, "Hi, ESP" English) + \texttt{wn9\_hiesp} (chuẩn). Không có wake word offline cho tiếng Việt — Espressif chưa ra. Phải dùng "Hi, ESP" hoặc "Nǐ hǎo, xiǎo zhì" (你好小智).
...
\begin{enumerate}
  \item Xiaozhi-esp32 GitHub: \url{https://github.com/78/xiaozhi-esp32}
